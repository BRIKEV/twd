...
const stages = [
  ...
  },
  {
    state: 'optional',
    eyebrow: 'AI agent',
    package: 'twd-ai + twd-cli',
    description: 'Add when you use AI coding agents. Tests run headlessly, no tab to keep open.',
    badge: '',
    cta: 'Learn more',
    href: '/ai-overview',
  ...
  },
  {
    ...
    package: 'twd-cli',
    description: 'The same runner in CI: PR recordings, coverage and contract validation.',
    badge: '',
    cta: 'Learn more',
