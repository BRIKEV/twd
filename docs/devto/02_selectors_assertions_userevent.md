...
In the [previous post](https://dev.to/kevinccbsg/getting-started-with-twd-installation-and-first-test-part-1-1a15), we set up our basic testing configuration and used the `visit` command to load our app.
...
In the [next post](https://dev.to/kevinccbsg/testing-while-developing-part-3-mocking-api-requests-41ld), we’ll explore one of the most powerful features of TWD: network mocking.
...
You can also learn more about selectors, assertions, and user events in our [official docs](https://brikev.github.io/twd/api/twd-commands.html).
